    ...
    public class ProductsController : Controller
    {
        ...
        public IActionResult UpdatePost(IFormCollection fc, int? id)
        {
            ...
            if (record != null)
            {
                ...
                //---
                //sản phẩm được gắn tag
                //xóa các bản ghi trong table CategoriesProducts có id tương ứng với sản phẩm này (trước khi insert dữ liệu mới)
                List<ItemTagsProducts> list_tag_product = db.TagsProducts.Where(item => item.ProductId == _id).ToList();
                ...
                db.SaveChanges();
                //---
                //lất các giá trị đã select ở select box để đưa vào list
        ...
        public IActionResult CreatePost(IFormCollection fc)
        {
            ...
            db.SaveChanges();
            //lấy id của bản ghi vừa mới insert
